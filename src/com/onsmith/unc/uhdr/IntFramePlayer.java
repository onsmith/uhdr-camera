...
public class IntFramePlayer implements Runnable, ChangeListener {
   ...
   * Constructor
   */
  public IntFramePlayer(int w, int h, int clock, int fps, double iMin, double iMax, Source<IntFrame> input) {
    this.clock = clock;
    this.fps   = fps;
    this.iMin  = iMin;
    this.iMax  = iMax;
