...
import com.onsmith.unc.uhdr.PixelFireToBufferedImage;
import com.onsmith.unc.uhdr.RawMP4Writer;
...
public class GenerateAquariumVideo {
  private static final int clock = (0x1 << 10), // Camera clock speed, in hertz
                           ...
                           Q     = 10,          // Q-factor to use (higher Q => lower quality)
  ...
  public static void main(String[] args) throws IOException {
    ...
    // Sink<BufferedImage>
    RawMP4Writer imageWriter = new RawMP4Writer(new File("out/demo.mp4"), fps, Q);
